!(function(t) {
        ...
        var r = t("html, body"),
            ...
            a = {
                ...
                storePageIn: function(e, i, n, r, s) {
                    ...
                    return (e[i] = { status: "loaded", title: o.find("title").first().text(), html: o.find("#" + r), doc: n, state: s }), e;
                },
            ...
            u = function(o, l) {
                            ...
                            m = {
                                loaded: function() {
                                    ...
                                    f && c ?
                                        ...
                                        i && ((d = l.alterChangeState({ id: h }, p[o.url].title, o.url)), (p[o.url].state = d), e.history.pushState(d, p[o.url].title, o.url)),
                                        f && !n && R(o.url);
                                },
                                fetching: function() {
                                    c ||
                ...
                return (
                    ...
                    null === e.history.state ? ((d = l.alterChangeState({ id: h }, i.title, m)), e.history.replaceState(d, i.title, m)) : (d = {}),
                    ...
                    k(u), { href: m, cache: p, clear: R, load: y, fetch: g, restartCSSAnimations: C }
                );
            },
            h = function(e) {
    ...
    function r() {
        ...
        for (var l in h)
            if (h.hasOwnProperty(l)) {
                ...
                for (r = n(e.fn, "function") ? e.fn() : e.fn, s = 0; s < t.length; s++)
                    (o = t[s]), (a = o.split(".")), 1 === a.length ? (f[a[0]] = r) : (!f[a[0]] || f[a[0]] instanceof Boolean || (f[a[0]] = new Boolean(f[a[0]])), (f[a[0]][a[1]] = r)), u.push((r ? "" : "no-") + a.join("-"));
            }
    }
    ...
    function l(t, i, n, r) {
        ...
        return (
            ...
            (f.id = c),
            d.fake && ((d.style.background = ""), (d.style.overflow = "hidden"), (h = p.style.overflow), (p.style.overflow = "hidden"), p.appendChild(d)),
            (l = i(f, t)),
            d.fake ? (d.parentNode.removeChild(d), (p.style.overflow = h), p.offsetHeight) : f.parentNode.removeChild(f), !!l
        );
    }
    var u = [],
        h = [],
    ...
    if (!n.TweenLite) {
                ...
                (this.check = function(h) {
                    ...
                    if (0 === v && o) {
                        if (((f = ("com.greensock." + r).split(".")), (p = f.pop()), (d = u(f.join("."))[p] = this.gsClass = o.apply(o, l)), a))
                            if (((n[p] = d), (g = "undefined" != typeof module && module.exports), !g && "function" == typeof define && define.amd))
        ...
        for (
            ...
            (o = r[s] + ",Power" + s), b(new x(null, null, 1, s), o, "easeOut", !0), b(new x(null, null, 2, s), o, "easeIn" + (0 === s ? ",easeNone" : "")), b(new x(null, null, 3, s), o, "easeInOut");
        ...
        (o.dispatchEvent = function(t) {
            var e,
                ...
                r = this._listeners[t];
            if (r)
                for (e = r.length, i = this._eventTarget; --e > -1;)(n = r[e]), n && (n.up ? n.c.call(n.s || i, { type: t, target: i }) : n.c.call(n.s || i));
        });
                ...
                var i,
                    ...
                    g = function(t) {
                        var e,
                            a,
                            l = O() - k;
                        l > d && (h += l - m), (k += l), (u.time = (k - h) / 1e3), (e = u.time - o), (!i || e > 0 || t === !0) && (u.frame++, (o += e + (e >= s ? 0.004 : s - e)), (a = !0)), t !== !0 && (r = n(g)), a && u.dispatchEvent(R);
                    };
                T.call(u),
                    (u.time = u.frame = 0),
                    (u.tick = function() {
        ...
        S(),
            ...
            (o.paused = function(t) {
                ...
                return (
                    ...
                    (l || t || a.wake(),
                        (e = n.rawTime()),
                        (i = e - this._pauseTime), !t && n.smoothChildTiming && ((this._startTime += i), this._uncache(!1)),
                        (this._pauseTime = t ? e : null),
                        (this._paused = t),
                        (this._active = this.isActive()), !t && 0 !== i && this._initted && this.duration() && ((e = n.smoothChildTiming ? this._totalTime : (e - this._startTime) / this._timeScale), this.render(e, e === this._totalTime, !0))),
        ...
        var E = _(
                ...
                function(e, i, n) {
                    ...
                    if (((this._overwrite = l = null == l ? G[E.defaultOverwrite] : "number" == typeof l ? l >> 0 : G[l]), (a || e instanceof Array || (e.push && d(e))) && "number" != typeof e[0]))
                        for (this._targets = o = f(e), this._propLookup = [], this._siblings = [], r = 0; r < o.length; r++)
                            (s = o[r]),
                            s ?
                            "string" != typeof s ?
                            s.length && s !== t && s[0] && (s[0] === t || (s[0].nodeType && s[0].style && !s.nodeType)) ?
                            (o.splice(r--, 1), (this._targets = o = o.concat(f(s)))) :
                            ((this._siblings[r] = $(s, this, !1)), 1 === l && this._siblings[r].length > 1 && J(s, this, null, 1, this._siblings[r])) :
                            ((s = o[r--] = E.selector(s)), "string" == typeof s && o.splice(r + 1, 1)) :
                            o.splice(r--, 1);
            ...
            N = function(t, e) {
                var i,
                    n = {};
                for (i in t)
                    q[i] || (i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i) || !(!V[i] || (V[i] && V[i]._autoCSS)) || ((n[i] = t[i]), delete t[i]);
                t.css = n;
            };
        (o = E.prototype = new C()),
        (o.constructor = E),
        ...
        var F = [],
            ...
            X = function(t, e, i, n) {
                var r,
                    ...
                    p = "",
                    d = 0;
                for (c.start = t, i && (i(c), (t = c[0]), (e = c[1])), c.length = 0, r = t.match(L) || [], s = e.match(L) || [], n && ((n._next = null), (n.blob = 1), (c._firstPT = n)), l = s.length, a = 0; l > a; a++)
                    (h = s[a]),
                    ...
                    (p && (c.push(p), (p = "")),
                        (o = parseFloat(r[a])),
                        c.push(o),
                        (c._firstPT = { _next: c._firstPT, t: c, p: c.length - 1, s: o, c: ("=" === h.charAt(1) ? parseInt(h.charAt(0) + "1", 10) * parseFloat(h.substr(2)) : parseFloat(h) - o) || 0, f: 0, r: d && 4 > d })),
                    (f += h.length);
            ...
            D = function(t, e, i, n, r, s, o, a) {
                ...
                return (
                    "number" !== c &&
                    ("function" === c && "get" === i && ((u = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3)), (p.s = h = o ? t[u](o) : t[u]())),
                        "string" == typeof h && (o || isNaN(h)) ?
                        ((p.fp = o), (l = X(h, n, a || E.defaultStringFilter, p)), (p = { t: l, p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: r || e, pr: 0 })) :
                        f || ((p.s = parseFloat(h)), (p.c = parseFloat(n) - p.s || 0))),
                    p.c ? ((p._next = this._firstPT) && (p._next._prev = p), (this._firstPT = p), p) : void 0
                );
            },
            Y = (E._internals = { isArray: d, isSelector: M, lazyTweens: F, blobDif: X }),
            V = (E._plugins = {}),
            B = (Y.tweenLookup = {}),
            U = 0,
            q = (Y.reservedProps = {
        ...
        var $ = function(t, e, i) {
                var n,
                    r,
                    s = t._gsTweenID;
                if ((B[s || (t._gsTweenID = s = "t" + U++)] || (B[s] = { target: t, tweens: [] }), e && ((n = B[s].tweens), (n[(r = n.length)] = e), i)))
            ...
            J = function(t, e, i, n, r) {
                ...
                for (s = r.length; --s > -1;)
                    ...
                    (a._timeline !== e._timeline ?
                        ...
                        a._startTime <= h && a._startTime + a.totalDuration() / a._timeScale > h && (((d || !a._initted) && h - a._startTime <= 2e-10) || (f[p++] = a)));
                for (s = p; --s > -1;)
        ...
        (o._init = function() {
            ...
            if (
                ((this._ease = u = u ? (u instanceof x ? u : "function" == typeof u ? new x(u, s.easeParams) : w[u] || E.defaultEase) : E.defaultEase),
        ...
        (o._initProps = function(e, i, n, r) {
            ...
            return r && this._kill(r, e) ?
                ...
                (this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)) && (I[e._gsTweenID] = !0), a);
        }),
        (o.render = function(t, e, i) {
            var n,
                r,
            ...
            if (t >= l - 1e-7)
                ...
                (this._startTime === this._timeline._duration && (t = 0),
                    (0 > u || (0 >= t && t >= -1e-7) || (u === c && "isPause" !== this.data)) && u !== t && ((i = !0), u > c && (r = "onReverseComplete")),
                    (this._rawPrevTime = o = !e || t || u === t ? t : c));
            else if (1e-7 > t)
                (this._totalTime = this._time = 0),
                (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                (0 !== a || (0 === l && u > 0)) && ((r = "onReverseComplete"), (n = this._reversed)),
                0 > t && ((this._active = !1), 0 === l && (this._initted || !this.vars.lazy || i) && (u >= 0 && (u !== c || "isPause" !== this.data) && (i = !0), (this._rawPrevTime = o = !e || t || u === t ? t : c))),
                this._initted || (i = !0);
                ...
                3 === f && (h *= 2),
                    ...
                    1 === f ? (this.ratio = 1 - h) : 2 === f ? (this.ratio = h) : 0.5 > t / l ? (this.ratio = h / 2) : (this.ratio = 1 - h / 2);
            } else this.ratio = this._ease.getRatio(t / l);
            if (this._time !== a || i) {
                if (!this._initted) {
                    if ((this._init(), !this._initted || this._gc)) return;
                    if (!i && this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)))
                        return (this._time = this._totalTime = a), (this._rawPrevTime = u), F.push(this), void(this._lazy = [t, e]);
                ...
                this._onUpdate && (0 > t && this._startAt && t !== -1e-4 && this._startAt.render(t, e, i), e || ((this._time !== a || n || i) && this._callback("onUpdate"))),
                    ...
                    (0 > t && this._startAt && !this._onUpdate && t !== -1e-4 && this._startAt.render(t, e, i),
                        n && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[r] && this._callback(r),
        ...
        _gsScope._gsDefine(
            ...
            function(t, e) {
                ...
                var h,
                    ...
                    B = (function() {
                        var t = V.indexOf("Android"),
                            e = j("a");
                        return (
                            (f = -1 !== V.indexOf("Safari") && -1 === V.indexOf("Chrome") && (-1 === t || Number(V.substr(t + 8, 1)) > 3)),
                            (d = f && Number(V.substr(V.indexOf("Version/") + 8, 1)) < 6),
                            (p = -1 !== V.indexOf("Firefox")),
                            (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(V) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(V)) && (m = parseFloat(RegExp.$1)), !!e && ((e.style.cssText = "top:1px;opacity:.55;"), /^0.55/.test(e.style.opacity))
                        );
                    })(),
                    U = function(t) {
                    ...
                    Z = (o.getStyle = function(t, e, i, n, r) {
                        var s;
                        return B || "opacity" !== e ?
                            (!n && t.style[e] ? (s = t.style[e]) : (i = i || Q(t)) ? (s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(z, "-$1").toLowerCase())) : t.currentStyle && (s = t.currentStyle[e]),
                    ...
                    $ = (Y.convertToPixels = function(t, i, n, r, s) {
                        ...
                        if ((p && (n = -n), d && (n *= 100), "%" === r && -1 !== i.indexOf("border"))) a = (n / 100) * (h ? t.clientWidth : t.clientHeight);
                            ...
                            c.appendChild(X),
                                ...
                                c.removeChild(X),
                                h && "%" === r && o.cacheWidths !== !1 && ((l = c._gsCache = c._gsCache || {}), (l.time = u), (l.width = (a / n) * 100)),
                                0 !== a || s || (a = $(t, i, n, r, !0));
                        }
                    ...
                    tt = function(t, e, i, n, r) {
                        ...
                        for (o in i)
                            ...
                            ((l[o] = "auto" !== s || ("left" !== o && "top" !== o) ? (("" !== s && "auto" !== s && "none" !== s) || "string" != typeof e[o] || "" === e[o].replace(v, "") ? s : 0) : K(t, o)),
                    ...
                    at = function(t, e, i, n) {
                        ...
                        return (
                            ...
                            ((r = 360),
                                ...
                                s.length &&
                                (n && (n[i] = e + o), -1 !== t.indexOf("short") && ((o %= r), o !== o % (r / 2) && (o = 0 > o ? o + r : o - r)), -1 !== t.indexOf("_cw") && 0 > o ? (o = ((o + 9999999999 * r) % r) - ((o / r) | 0) * r) : -1 !== t.indexOf("ccw") && o > 0 && (o = ((o - 9999999999 * r) % r) - ((o / r) | 0) * r)),
                                (a = e + o)),
                            u > a && a > -u && (a = 0),
                            a
                        );
                    ...
                    ht = (o.parseColor = function(t, e) {
                        ...
                        return (
                            ...
                            ((n = i[0] / 255),
                                ...
                                (h = Math.min(n, r, s)),
                                (l = (u + h) / 2),
                                u === h ? (o = a = 0) : ((c = u - h), (a = l > 0.5 ? c / (2 - u - h) : c / (u + h)), (o = u === n ? (r - s) / c + (s > r ? 6 : 0) : u === r ? (s - n) / c + 2 : (n - r) / c + 4), (o *= 60)),
                                (i[0] = (o + 0.5) | 0),
                                (i[1] = (100 * a + 0.5) | 0),
                                (i[2] = (100 * l + 0.5) | 0)),
                            i
                ...
                var pt = function(t, e, i, n) {
                    ...
                    _t = (o.parseComplex = function(t, e, i, n, r, s, a, l, u, c) {
                        ...
                        var f,
                            ...
                            S = h !== !1;
                        for (
                            (-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && ((O = O.join(" ").replace(E, ", ").split(" ")), (k = k.join(" ").replace(E, ", ").split(" ")), (C = O.length)),
                            ...
                            (B || (w = !1),
                                P ?
                                a
                                .appendXtra(w ? "hsla(" : "hsl(", m[0], st(_[0], m[0]), ",", !1, !0)
                                .appendXtra("", m[1], st(_[1], m[1]), "%,", !1)
                                .appendXtra("", m[2], st(_[2], m[2]), w ? "%," : "%" + z, !1) :
                                a
                                .appendXtra(w ? "rgba(" : "rgb(", m[0], _[0] - m[0], ",", !0, !0)
                                .appendXtra("", m[1], _[1] - m[1], ",", !0)
                                .appendXtra("", m[2], _[2] - m[2], w ? "," : z, !0),
                                w && ((m = m.length < 4 ? 1 : m[3]), a.appendXtra("", m, (_.length < 4 ? 1 : _[3]) - m, z, !1))),
                            (ft.lastIndex = 0);
                        else if ((v = m.match(R))) {
                ...
                (u.appendXtra = function(t, e, i, n, r, s) {
                    ...
                    return (
                        ...
                        (o.l++,
                            ...
                            (o["xs" + o.l] = n || ""),
                            a > 0 ?
                            ((o.data["xn" + a] = e + i), (o.rxp["xn" + a] = r), (o["xn" + a] = e), o.plugin || ((o.xfirst = new Rt(o, "xn" + a, e, i, o.xfirst || o, 0, o.n, r, o.pr)), (o.xfirst.xs0 = 0)), o) :
                ...
                (u.parseComplex = function(t, e, i, n, r, s) {
                    ...
                    if ((this.multi && (E.test(i) || E.test(e) ? ((a = e.replace(E, "|").split("|")), (l = i.replace(E, "|").split("|"))) : f && ((a = [e]), (l = [i]))), l)) {
                        for (u = l.length > a.length ? l.length : a.length, o = 0; u > o; o++)
                            (e = a[o] = a[o] || this.dflt), (i = l[o] = l[o] || this.dflt), f && ((h = e.indexOf(f)), (c = i.indexOf(f)), h !== c && (-1 === c ? (a[o] = a[o].split(f).join("")) : -1 === h && (a[o] += " " + f)));
                        (e = a.join(", ")), (i = l.join(", "));
                    }
                ...
                var bt,
                    ...
                    Nt = function(t, e, i, n, r, s) {
                        ...
                        x && ((v = x.xOrigin), (y = x.yOrigin)),
                            ...
                            (s && ((i.xOffset = x.xOffset), (i.yOffset = x.yOffset), (x = i)),
                                r || (r !== !1 && o.defaultSmoothOrigin !== !1) ? ((l = h - v), (u = c - y), (x.xOffset += l * w[0] + u * w[2] - l), (x.yOffset += l * w[1] + u * w[3] - u)) : (x.xOffset = x.yOffset = 0)),
                    ...
                    jt = function(t, e) {
                        ...
                        if (
                            (zt ?
                                (n = Z(t, Pt, null, !0)) :
                                t.currentStyle && ((n = t.currentStyle.filter.match(S)), (n = n && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), l.x || 0, l.y || 0].join(",") : "")),
                                ...
                                (i && -1 !== (h[zt] + "").indexOf("matrix") && ((n = h[zt]), (i = 0)),
                                    (r = t.getAttribute("transform")),
                                    i && r && (-1 !== r.indexOf("matrix") ? ((n = r), (i = 0)) : -1 !== r.indexOf("translate") && ((n = "matrix(1,0,0,1," + r.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")"), (i = 0)))),
                                i)
                        )
                            return Lt;
                        for (r = (n || "").match(R) || [], vt = r.length; --vt > -1;)(s = Number(r[vt])), (r[vt] = (o = s - (s |= 0)) ? ((o * u + (0 > o ? -0.5 : 0.5)) | 0) / u + s : s);
                        ...
                        if (((f.svg = !(!t.getBBox || !It(t))), f.svg && (Nt(t, Z(t, Ot, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), (bt = o.useSVGTransformAttr || Mt)), (s = jt(t)), s !== Lt)) {
                            if (16 === s.length) {
                                var _,
                                    ...
                                    j = s[11],
                                    X = Math.atan2(C, M);
                                f.zOrigin && ((L = -f.zOrigin), (N = A * L - s[12]), (I = E * L - s[13]), (L = M * L + f.zOrigin - s[14])),
                                    (f.rotationX = X * F),
                                    X &&
                                    ((x = Math.cos(-X)),
                                        (w = Math.sin(-X)),
                                    ...
                                    (X = Math.atan2(-z, M)),
                                    (f.rotationY = X * F),
                                    X && ((x = Math.cos(-X)), (w = Math.sin(-X)), (_ = b * x - A * w), (v = T * x - E * w), (y = z * x - M * w), (E = T * w + E * x), (M = z * w + M * x), (j = P * w + j * x), (b = _), (T = v), (z = y)),
                                    (X = Math.atan2(T, b)),
                                    (f.rotation = X * F),
                                    X && ((x = Math.cos(-X)), (w = Math.sin(-X)), (b = b * x + O * w), (v = T * x + k * w), (k = T * -w + k * x), (C = z * -w + C * x), (T = v)),
                                    ...
                                    (f.skewX = 0) :
                                    ((f.skewX = O || k ? Math.atan2(O, k) * F + f.rotation : f.skewX || 0),
                                        Math.abs(f.skewX) > 90 &&
                                    ...
                                    (f.y = I),
                                    (f.z = L),
                                    f.svg && ((f.x -= f.xOrigin - (f.xOrigin * b - f.yOrigin * O)), (f.y -= f.yOrigin - (f.yOrigin * T - f.xOrigin * k)));
                                ...
                                Math.abs(c) > 90 && Math.abs(c) < 270 && (p ? ((l *= -1), (c += 0 >= h ? 180 : -180), (h += 0 >= h ? 180 : -180)) : ((u *= -1), (c += 0 >= c ? 180 : -180))),
                                    (f.scaleX = l),
                                    (f.scaleY = u),
                                    (f.rotation = h),
                                    (f.skewX = c),
                                    kt && ((f.rotationX = f.rotationY = f.z = 0), (f.perspective = g), (f.scaleZ = 1)),
                                    f.svg && ((f.x -= f.xOrigin - (f.xOrigin * Y + f.yOrigin * B)), (f.y -= f.yOrigin - (f.xOrigin * V + f.yOrigin * U)));
                            }
                            f.zOrigin = R;
                    ...
                    Dt = function(t) {
                        ...
                        if (f) {
                            ...
                            if (
                                (null != n.ox && ((p = (n.oxp ? R * n.ox * 0.01 : n.ox) - R / 2), (d = (n.oyp ? g * n.oy * 0.01 : n.oy) - g / 2), (w += p - (p * a + d * l)), (b += d - (p * u + d * h))),
                                    _ ? ((p = R / 2), (d = g / 2), (v += ", Dx=" + (p - (p * a + d * l) + w) + ", Dy=" + (d - (p * u + d * h) + b) + ")")) : (v += ", sizingMethod='auto expand')"), -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? (c.filter = e.replace(A, v)) : (c.filter = v + " " + e),
                                    (0 === t || 1 === t) &&
                                    1 === a &&
                                    0 === l &&
                                    0 === u &&
                                    1 === h &&
                                    ((_ && -1 === v.indexOf("Dx=0, Dy=0")) || (x.test(e) && 100 !== parseFloat(RegExp.$1)) || (-1 === e.indexOf(e.indexOf("Alpha")) && c.removeAttribute("filter"))), !_)
                            ) {
                                var T,
                                    z,
                                    P,
                    ...
                    Yt = (Y.set3DTransformRatio = Y.setTransformRatio = function(t) {
                        ...
                        if (((((1 === t || 0 === t) && "auto" === X && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime)) || !X) && !I && !j && !C && !k && 1 === E) || (bt && L) || !kt)
                            return void(O || z.skewX || L ?
                                ((O *= N),
                                    ...
                                    (i = Math.sin(O - b) * -A),
                                    (s = Math.cos(O - b) * A),
                                    b && "simple" === z.skewType && ((_ = Math.tan(b)), (_ = Math.sqrt(1 + _ * _)), (i *= _), (s *= _), z.skewY && ((e *= _), (r *= _))),
                                    L &&
                                    ((M += z.xOrigin - (z.xOrigin * e + z.yOrigin * i) + z.xOffset),
                                        (F += z.yOrigin - (z.xOrigin * r + z.yOrigin * s) + z.yOffset),
                                        bt && (z.xPercent || z.yPercent) && ((m = this.t.getBBox()), (M += 0.01 * z.xPercent * m.width), (F += 0.01 * z.yPercent * m.height)),
                                        (m = 1e-6),
                                        m > M && M > -m && (M = 0),
                                        m > F && F > -m && (F = 0)),
                                    (y = ((e * T) | 0) / T + "," + ((r * T) | 0) / T + "," + ((i * T) | 0) / T + "," + ((s * T) | 0) / T + "," + M + "," + F + ")"),
                                    L && bt ? this.t.setAttribute("transform", "matrix(" + y) : (P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix(" : "matrix(") + y)) :
                                (P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix(" : "matrix(") + S + ",0,0," + A + "," + M + "," + F + ")"));
                        if ((p && ((m = 1e-4), m > S && S > -m && (S = E = 2e-5), m > A && A > -m && (A = E = 2e-5), !j || z.z || z.rotationX || z.rotationY || (j = 0)), O || z.skewX))
                            (O *= N),
                            (R = e = Math.cos(O)),
                            (g = r = Math.sin(O)),
                            z.skewX && ((O -= z.skewX * N), (R = Math.cos(O)), (g = Math.sin(O)), "simple" === z.skewType && ((_ = Math.tan(z.skewX * N)), (_ = Math.sqrt(1 + _ * _)), (R *= _), (g *= _), z.skewY && ((e *= _), (r *= _)))),
                            (i = -g),
                            (s = R);
                        else {
                            if (!(C || k || 1 !== E || j || L))
                        ...
                        (w = "0"),
                        (O = C * N),
                        O && ((R = Math.cos(O)), (g = Math.sin(O)), (a = -g), (h = f * -g), (n = e * g), (o = r * g), (u = R), (f *= R), (e *= R), (r *= R)),
                            (O = k * N),
                            O && ((R = Math.cos(O)), (g = Math.sin(O)), (_ = i * R + n * g), (v = s * R + o * g), (l = u * g), (c = f * g), (n = i * -g + n * R), (o = s * -g + o * R), (u *= R), (f *= R), (i = _), (s = v)),
                            1 !== E && ((n *= E), (o *= E), (u *= E), (f *= E)),
                            1 !== A && ((i *= A), (s *= A), (l *= A), (c *= A)),
                            1 !== S && ((e *= S), (r *= S), (a *= S), (h *= S)),
                            (d || L) &&
                            (d && ((M += n * -d), (F += o * -d), (I += u * -d + d)),
                                L && ((M += z.xOrigin - (z.xOrigin * e + z.yOrigin * i) + z.xOffset), (F += z.yOrigin - (z.xOrigin * r + z.yOrigin * s) + z.yOffset)),
                                m > M && M > -m && (M = w),
                                m > F && F > -m && (F = w),
                                m > I && I > -m && (I = 0)),
                            ...
                            k || C || 1 !== E ?
                            ((y += x + (m > l && l > -m ? w : l) + x + (m > c && c > -m ? w : c) + x + (m > n && n > -m ? w : n)), (y += x + (m > o && o > -m ? w : o) + x + (m > u && u > -m ? w : u) + x + (m > f && f > -m ? w : f) + x)) :
                            (y += ",0,0,0,0,1,0,"),
                ...
                xt(
                            ...
                            parser: function(t, e, i, n, s, a, l) {
                                ...
                                if (((n._transform = z), "string" == typeof w.transform && zt))
                                    ...
                                    ((m = z.xOrigin),
                                        ...
                                        ((c = {}), Nt(t, rt(w.transformOrigin), c, w.svgOrigin, w.smoothOrigin, !0), (m = c.xOrigin), (R = c.yOrigin), (u.x -= c.xOffset - z.xOffset), (u.y -= c.yOffset - z.yOffset)),
                                        (m || R) && ((g = jt(X, !0)), (u.x -= m - (m * g[0] + R * g[2])), (u.y -= R - (m * g[1] + R * g[3])))),
                                    ...
                                    if (
                                        ...
                                        "string" == typeof w.x && -1 !== w.x.indexOf("%") && ((u.x = 0), (u.xPercent = ot(w.x, z.xPercent))),
                                        "string" == typeof w.y && -1 !== w.y.indexOf("%") && ((u.y = 0), (u.yPercent = ot(w.y, z.yPercent))),
                                        ...
                                        kt &&
                                        ((u.rotationX = at("rotationX" in w ? w.rotationX : "shortRotationX" in w ? w.shortRotationX + "_short" : z.rotationX || 0, z.rotationX, "rotationX", b)),
                                        ...
                                        (u.skewY = at(w.skewY, z.skewY)) && ((u.skewX += u.skewY), (u.rotation += u.skewY));
                                }
                                for (
                                    ...
                                    (i = Tt[x]),
                                    (c = u[i] - z[i]),
                                    (c > y || -y > c || null != w[i] || null != I[i]) && ((p = !0), (s = new Rt(z, i, z[i], c, s)), i in b && (s.e = b[i]), (s.xs0 = 0), (s.plugin = a), n._overwriteProps.push(s.n));
                                return (
                                    (c = w.transformOrigin),
                                    z.svg &&
                                    (c || w.svgOrigin) &&
                                    ((m = z.xOffset),
                                        ...
                                        (m !== z.xOffset || R !== z.yOffset) && ((s = gt(z, "xOffset", _ ? m : z.xOffset, z.xOffset, s, T)), (s = gt(z, "yOffset", _ ? R : z.yOffset, z.yOffset, s, T))),
                                        (c = bt ? null : "0px 0px")),
                                    (c || (kt && f && z.zOrigin)) &&
                                    (zt ?
                                        ((p = !0),
                    ...
                    xt("boxShadow", { defaultValue: "0px 0px 0px 0px #999", prefix: !0, color: !0, multi: !0, keyword: "inset" }),
                    xt("borderRadius", {
                        defaultValue: "0px",
                        parser: function(t, e, i, s, o, a) {
                            ...
                            var l,
                                ...
                                z = t.style;
                            for (R = parseFloat(t.offsetWidth), g = parseFloat(t.offsetHeight), l = e.split(" "), u = 0; u < T.length; u++)
                                this.p.indexOf("border") && (T[u] = H(T[u])),
                                (f = c = Z(t, T[u], r, !1, "0px")), -1 !== f.indexOf(" ") && ((c = f.split(" ")), (f = c[0]), (c = c[1])),
                                (p = h = l[u]),
                                (d = parseFloat(f)),
                                (v = f.substr((d + "").length)),
                                (y = "=" === p.charAt(1)),
                                y ? ((m = parseInt(p.charAt(0) + "1", 10)), (p = p.substr(2)), (m *= parseFloat(p)), (_ = p.substr((m + "").length - (0 > m ? 1 : 0)) || "")) : ((m = parseFloat(p)), (_ = p.substr((m + "").length))),
                                "" === _ && (_ = n[i] || v),
                                _ !== v &&
                                ((x = $(t, "borderLeft", d, v)),
                                    (w = $(t, "borderTop", d, v)),
                                    "%" === _ ? ((f = (x / R) * 100 + "%"), (c = (w / g) * 100 + "%")) : "em" === _ ? ((b = $(t, "borderLeft", 1, "em")), (f = x / b + "em"), (c = w / b + "em")) : ((f = x + "px"), (c = w + "px")),
                                    y && ((p = parseFloat(f) + m + _), (h = parseFloat(c) + m + _))),
                    ...
                    xt("backgroundPosition", {
                        ...
                        parser: function(t, e, i, n, s, o) {
                            ...
                            if ((-1 !== R.indexOf("%")) != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && ((f = Z(t, "backgroundImage").replace(O, "")), f && "none" !== f)) {
                                for (a = R.split(" "), l = g.split(" "), D.setAttribute("src", f), u = 2; --u > -1;)
                                    (R = a[u]),
                                    (h = -1 !== R.indexOf("%")),
                                    h !== (-1 !== l[u].indexOf("%")) && ((c = 0 === u ? t.offsetWidth - D.width : t.offsetHeight - D.height), (a[u] = h ? (parseFloat(R) / 100) * c + "px" : (parseFloat(R) / c) * 100 + "%"));
                                R = a.join(" ");
                            }
                    ...
                    xt("margin", { parser: dt("marginTop,marginRight,marginBottom,marginLeft") }),
                    xt("padding", { parser: dt("paddingTop,paddingRight,paddingBottom,paddingLeft") }),
                    xt("clip", {
                        ...
                        parser: function(t, e, i, n, s, o) {
                            ...
                            return (
                                9 > m ?
                                ((l = t.currentStyle), (u = 8 > m ? " " : ","), (a = "rect(" + l.clipTop + u + l.clipRight + u + l.clipBottom + u + l.clipLeft + ")"), (e = this.format(e).split(",").join(u))) :
                                ((a = this.format(Z(t, this.p, r, !1, this.dflt))), (e = this.format(e))),
                                this.parseComplex(t.style, a, e, s, o)
                            );
                        },
                    }),
                    xt("textShadow", { defaultValue: "0px 0px 0px #999", color: !0, multi: !0 }),
                    ...
                    xt("border", {
                        ...
                        parser: function(t, e, i, n, s, o) {
                            var a = Z(t, "borderTopWidth", r, !1, "0px"),
                                ...
                                u = l[0].replace(y, "");
                            return (
                                "px" !== u && (a = parseFloat(a) / $(t, "borderTopWidth", 1, u) + u),
                    ...
                    xt("borderWidth", { parser: dt("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }),
                ...
                var Vt = function(t) {
                    var e,
                        ...
                        r = (this.s + this.c * t) | 0;
                    100 === r && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), (e = !Z(this.data, "filter"))) : ((i.filter = n.replace(b, "")), (e = !0))),
                        e || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + r + ")"), -1 === n.indexOf("pacity") ? (0 === r && this.xn1) || (i.filter = n + " alpha(opacity=" + r + ")") : (i.filter = n.replace(x, "opacity=" + r)));
                };
                    ...
                    parser: function(t, e, i, n, s, o) {
                        ...
                        return (
                            ...
                            ((s = new Rt(l, "opacity", 100 * a, 100 * (e - a), s)),
                                ...
                                (s.plugin = o),
                                (s.setRatio = Vt)),
                            u && ((s = new Rt(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")), (s.xs0 = "inherit"), n._overwriteProps.push(s.n), n._overwriteProps.push(i)),
                            s
                        );
                    },
                });
                ...
                (u._onInitTween = function(t, e, a) {
                    ...
                    var u,
                        ...
                        b = t.style;
                    if (
                        (c && "" === b.zIndex && ((u = Z(t, "zIndex", r)), ("auto" === u || "" === u) && this._addLazySet(b, "zIndex", 0)),
                            "string" == typeof e && ((R = b.cssText), (u = J(t, r)), (b.cssText = R + ";" + e), (u = tt(t, u, J(t)).difs), !B && w.test(e) && (u.opacity = parseFloat(RegExp.$1)), (e = u), (b.cssText = R)),
                        ...
                        for (
                            ...
                            f &&
                            ((c = !0),
                                "" === b.zIndex && ((v = Z(t, "zIndex", r)), ("auto" === v || "" === v) && this._addLazySet(b, "zIndex", 0)),
                                d && this._addLazySet(b, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) :
                            (b.zoom = 1),
                            m = p; m && m._next;
                ...
                (u.parse = function(t, e, i, s) {
                    ...
                    for (o in e)
                        ...
                        ((f = Z(t, o, r) + ""),
                            (R = "string" == typeof p),
                            "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || (R && T.test(p)) ?
                            (R || ((p = ht(p)), (p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")")), (i = _t(_, o, f, p, !0, "transparent", i, 0, s))) :
                            R && M.test(p) ?
                            (i = _t(_, o, f, p, !0, null, i, 0, s)) :
                            ((u = parseFloat(f)),
                                (d = u || 0 === u ? f.substr((u + "").length) : ""),
                                ("" === f || "auto" === f) &&
                                ("width" === o || "height" === o ? ((u = nt(t, o, r)), (d = "px")) : "left" === o || "top" === o ? ((u = K(t, o, r)), (d = "px")) : ((u = "opacity" !== o ? 0 : 1), (d = ""))),
                                (g = R && "=" === p.charAt(1)),
                                g ? ((c = parseInt(p.charAt(0) + "1", 10)), (p = p.substr(2)), (c *= parseFloat(p)), (m = p.replace(y, ""))) : ((c = parseFloat(p)), (m = R ? p.replace(y, "") : "")),
                                "" === m && (m = o in n ? n[o] : d),
                                ...
                                ((u = $(t, o, u, d)),
                                    "%" === m ?
                                    ((u /= $(t, o, 100, "%") / 100), e.strictUnits !== !0 && (f = u + "%")) :
                                ...
                                g && (c += u),
                                (!u && 0 !== u) || (!c && 0 !== c) ?
                                void 0 !== _[o] && (p || (p + "" != "NaN" && null != p)) ?
                                ((i = new Rt(_, o, c || u || 0, 0, i, -1, o, !1, 0, f, p)), (i.xs0 = "none" !== p || ("display" !== o && -1 === o.indexOf("Style")) ? p : f)) :
                                q("invalid " + o + " tween value: " + e[o]) :
                                ((i = new Rt(_, o, u, c - u, i, 0, o, h !== !1 && ("px" === m || "zIndex" === o), 0, f, p)), (i.xs0 = m)))),
            ...
            n = _gsScope._gsDefine.plugin({
                ...
                init: function(t, n, r) {
                    return (
                        ...
                        null != n.y ? (this._addTween(this, "y", this.y, "max" === n.y ? i(t, "y") : n.y, "scrollTo_y", !0), this._overwriteProps.push("scrollTo_y")) : (this.skipY = !0), !0
                    );
                },
                set: function(t) {
                    ...
                    this.x < 0 && (this.x = 0),
                        this.y < 0 && (this.y = 0),
                        this._autoKill &&
                        (!this.skipX && (o > 7 || o < -7) && n < i(this._target, "x") && (this.skipX = !0), !this.skipY && (s > 7 || s < -7) && r < i(this._target, "y") && (this.skipY = !0),
    ...
    (function(t) {
        ...
        function n(e) {
            return this.each(function() {
                e && t.extend(c, e);
                var i = t(this),
                    n = { options: e, _currSpeed: 0, _updateSpeedTimeout: null, _lastMousePos: null, _currMousePos: null, _hasAttachedMousemoveEvent: !1 };
        ...
        var u = "cursometer",
            ...
            c = { updateSpeedRate: 20, captureMouseMoveRate: 15, onUpdateSpeed: t.noop };
        ...
        return (function(t) {
            ...
            function(t, e, i) {
                ...
                var s = i(1),
                    o = i(3),
                    a = n(o),
                    l = { characters: "AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz~!@#$%^&*()-+=[]{}|;:,./<>?".split(""), speed: 50 },
                    u = (function() {
                        function t(e, i) {
        ...
        return (function(t) {
            ...
            function(t, e, i) {
                ...
                var r = (function() {
                    ...
                    o = (function() {
                        function t(e) {
                            n(this, t), (this.current = []), (this.elements = e), (this.handlers = { enter: [], exit: [] }), (this.singles = { enter: [], exit: [] });
                        }
                        return (
                            r(t, [{
                                    key: "check",
            ...
            function(t, e, i) {
                function n(t, e, i) {
                    ...
                    return s(i) && ((n = "leading" in i ? !!i.leading : n), (a = "trailing" in i ? !!i.trailing : a)), r(t, e, { leading: n, maxWait: e, trailing: a });
                }
                var r = i(6),
                    s = i(2),
        ...
        (i.prototype.scan = function(t) {
            for (var e, i, n, r, s = t.querySelectorAll(this.TYPES.join(",")), o = 0; o < s.length; o++)
                (i = s[o]), (e = this[i.tagName.toLowerCase() + "ToPath"]), (n = e(this.parseAttr(i.attributes))), (r = this.pathMaker(i, n)), i.parentNode.replaceChild(r, i);
        }),
                ...
                case t.HTMLObjectElement:
                    ...
                    (s = function(t) {
                        if (!o.isReady) {
                            ...
                            return o.el ?
                                (i.getAttribute("built-by-vivus") && (o.parentEl.insertBefore(o.el, i), o.parentEl.removeChild(i), o.el.setAttribute("width", "100%"), o.el.setAttribute("height", "100%")),
                                    (o.isReady = !0),
                                    o.init(), !0) :
                                void 0;
                        }
        ...
        (n.prototype.mapping = function() {
            var e, i, n, r, s, a, l, u;
            for (u = a = l = 0, i = this.el.querySelectorAll("path"), e = 0; e < i.length; e++)
                (n = i[e]),
                this.isInvisible(n) ||
                ((s = { el: n, length: Math.ceil(n.getTotalLength()) }),
                    ...
                    (this.map.push(s),
                        ...
                        (a += s.length),
                        this.renderPath(e)));
            for (a = 0 === a ? 1 : a, this.delay = null === this.delay ? this.duration / 3 : this.delay, this.delayUnit = this.delay / (i.length > 1 ? i.length - 1 : 1), e = 0; e < this.map.length; e++) {
        ...
        (n.prototype.trace = function() {
            ...
            for (n = this.animTimingFunction(this.currentFrame / this.frameLength) * this.frameLength, t = 0; t < this.map.length; t++)
                ...
                i.progress !== e && ((i.progress = e), (i.el.style.strokeDashoffset = Math.floor(i.length * (1 - e))), this.renderPath(t));
        }),
...
var Util = (function(t) {
        ...
        var e = t(".main-navigation"),
            ...
            u = function() {
                var e = t(document).find("title").text(),
                    i = "Imagination is more important than knowledge :P";
                document.addEventListener("visibilitychange", function() {
                    document.hidden ? t(document).find("title").text(i) : t(document).find("title").text(e);
                });
            },
            h = function(t) {
                "function" == typeof window.ga && (ga("set", "page", t), ga("send", "pageview"));
            },
            c = function(t, e, i) {
                if ("function" != typeof window.ga) return;
                i ? ga("send", "event", t, e, i) : ga("send", "event", t, e);
            },
            f = function() {
                console.info(),
                    console.info("Designed and Developed By Amine ELKHAL"),
                    console.info("👮🏿🚨👮🏿🚨 WEEWOO WEEWOO 👮🏿🚨👮🏿 IT'S THE 💾 AMINEELKHAL.COM POLICE HERE 👌🏿 just tryn' to make SURE 👀 EVERYTHING IS 🛡💯💯 SAFE 😔 PLEASE ENJOY 🕋💥 OR JAVASCRIPT WILL ⚰️✈️🏙 SOCC YOU 😩🔥👌🏿");
            },
            p = function() {
                o(), a(), r(), s(), n(), l();
            };
    ...
    AnimationManager = (function(t) {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        TweenLite.to(h, 1, {
                            ...
                            TweenLite.to(f, 1, { x: "-100%", ease: Power4.easeInOut, delay: 0.09 });
                    }, 2500);
            },
            d = function() {
                function t(t) {
                ...
                function e() {
                    TweenLite.to(".layer1", r, { x: i, y: -n, ease: Power4.easeOut }), TweenLite.to(".layer2", s, { x: -i, y: n, ease: Power4.easeOut });
                }
                var i,
                    n,
                    r = 1,
                ...
                if (Modernizr.mq("(min-width: 1024px)")) {
                    ...
                    inView.offset(230),
                        ...
                        inView(".experiments-mask-reveal").on("enter", function(t) {
                            TweenLite.to(i, 0.6, { y: "-100%", ease: Power4.easeInOut }), TweenLite.to(n, 0.6, { y: "-100%", delay: 0.09, ease: Power4.easeInOut });
                        }),
        ...
        return { init: y, startLoadAnimation: g, manageOnBefore: h, manageOnStart: c, manageOnReady: f, manageOnAfter: p, animateHeroShapes: d };
    })(jQuery),
